<script>
  // Icons are trickier in Svelte without a library like lucide-svelte. 
  // We can use SVG directly for MVP.
</script>
...
<nav class="flex items-center justify-between px-6 py-3 border-b border-border bg-card">
  ...
  <div class="flex items-center gap-4">
    ...
    <div class="w-8 h-8 rounded-full bg-primary/20 border border-primary/50 flex items-center justify-center text-xs font-serif text-primary">
      JD
    </div>
  </div>
</nav>
